...
The accented variants from the Bootstrap tables page are arguments rather than
classes you have to remember, and they compose:
...
`row_variant` is recycled to the number of rows, so a single value colours them
all, and `NA` leaves a row alone. `"active"` is accepted alongside the theme
colours.
